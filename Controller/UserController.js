...
const login = async (req, res) => {
    try {
        ...
        res.status(200).json({ msg: 'User logged in', token, user: { _id, email: userEmail, isAdmin } });
...
// Controller function for user dashboard
...
// Controller function to verify OTP for password reset
